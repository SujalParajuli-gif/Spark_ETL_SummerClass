...
def create_master_table(output_dir, artists_df, recommendations_df, tracks_df):
    ...
    tracks_df = tracks_df.withColumn("id_artists_array", F.from_json(F.col("id_artists"), ArrayType(StringType())))
...
def create_query_tables(output_dir, artists_df, recommendations_df, tracks_df):
    ...
    tracks_exploded = tracks_df.withColumn("id_artists_array", F.from_json(F.col("id_artists"), ArrayType(StringType()))) \
